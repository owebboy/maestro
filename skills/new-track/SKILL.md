...
Detect Superpowers availability: check for `superpowers:brainstorming` (plugin-installed) or `brainstorming` (project-scoped). Use whichever is found.
...
Detect Superpowers availability: check for `superpowers:writing-plans` (plugin-installed) or `writing-plans` (project-scoped). Use whichever is found.
